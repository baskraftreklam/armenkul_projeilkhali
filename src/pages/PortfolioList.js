...
import { FaCity, FaHome, FaTag, FaRulerCombined, FaMapMarkedAlt, FaBed, FaFire, FaChair, FaExchangeAlt, FaCar, FaSearch, FaFileContract } from 'react-icons/fa';
...
function PortfolioList({ properties, onDeletePortfolio }) {
  ...
  const isDaireOrVilla = filters.propertyType === 'Daire' || filters.propertyType === 'Villa';
  const isArsa = filters.propertyType === 'Arsa';
  
  // Animasyon için başlık metni
  const titleText = "Talepify!";
  
  return (
    // --- DEĞİŞİKLİK: Ana kapsayıcı div'i Fragment'a çeviriyoruz (<> </>) ---
    <>
      <div className="main-title-container">
          ...
          <p className="main-subtitle">Emlakçıların İsveç Çakısı!</p>
      </div>
      ...
      <div className="portfolio-list-page">
          ...
          <div className="filters">
             <div className="filter-header">
              ...
              <div className="filter-buttons">
               ...
               <div className="filter-group">
                  <label><FaHome /> Portföy Tipi</label>
              ...
              <div className="filter-group">
                <label><FaTag /> Fiyat Aralığı (₺)</label>
              ...
              <div className="filter-group">
                 <label htmlFor="neighborhood-filter">
                   <FaMapMarkedAlt /> Mahalle {currentUser?.city && `(${currentUser.city})`}
                 </label>
              ...
              <div className={`filter-group-wrapper ${!isDaireOrVilla ? 'hidden' : ''}`}>
                  <div className="filter-group">
                    <label><FaRulerCombined /> Metrekare Aralığı (m²)</label>
                  ...
                  <div className="filter-group">
                      <label><FaFire /> Isıtma Tipi</label>
                  ...
                  <div className="filter-group">
                      <label><FaChair /> Eşya Durumu</label>
              ...
              <div className={`filter-group-wrapper ${!isArsa ? 'hidden' : ''}`}>
                  <div className="filter-group">
                      <label><FaRulerCombined /> Metrekare Aralığı (m²)</label>
                      <div className="range-labels"><span>{filters.squareMetersRange[0]} m²</span><span>{filters.squareMetersRange[1]} m²</span></div>
                      <Slider range min={0} max={maxSquareMeters} step={5} value={filters.squareMetersRange} onChange={value => handleFilterChange('squareMetersRange', value)} />
                  ...
                  <div className="filter-group">
                      <label><FaExchangeAlt /> Takas</label>
                  ...
                  <div className="filter-group">
                      <label><FaFileContract /> Tapu Durumu (İmar)</label>
                      <select value={filters.deedStatus} onChange={e => handleFilterChange('deedStatus', e.target.value)}>
                          <option value="Tümü">Tümü</option>
                          <option value="Arsa Payı">Arsa</option>
        ...
        <div className="property-list-container">
          ...
          <div className="property-grid" key={gridKey}>
